      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="bg-white p-10 md:p-16 rounded-[2rem] border border-slate-200 shadow-sm">
          ...
          <div className="space-y-6 text-slate-600 leading-relaxed font-medium">
            <div className="bg-slate-50 p-6 rounded-2xl mb-8 border border-slate-200 text-sm">
              <p className="font-bold text-slate-900 mb-2">SEVEN MARKETING DIGITAL, S.A. DE C.V. • Crovexa</p>
              <p>Portal crovexa.com • Línea de Atención: informes@crovexa.com</p>
            ...
            <p>En SEVEN MARKETING DIGITAL, S.A. DE C.V. (en adelante “Crovexa”), asumimos un compromiso serio y permanente con la protección y el manejo responsable de los datos personales que recabamos de nuestros clientes, usuarios y visitantes del sitio web crovexa.com. {/* [cite: 186, 187] */}</p>
            ...
            <p>La información que Crovexa solicita es únicamente la necesaria para poder prestar sus servicios, procesar pagos, atender solicitudes y cumplir con las obligaciones contractuales y legales derivadas de la relación con el usuario. {/* [cite: 190] */}</p>
            ...
            <p>Crovexa podrá compartir los datos personales del titular únicamente en los siguientes casos: {/* [cite: 204] */}</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p>En ningún caso Crovexa venderá, alquilará o comercializará los datos personales a terceros ajenos a las finalidades aquí descritas. {/* [cite: 208] */}</p>

            <h2 className="text-2xl font-bold text-slate-900 mt-8">4. Derechos ARCO y medios para ejercerlos</h2>
            <p>El titular podrá ejercer en cualquier momento sus derechos de Acceso, Rectificación, Cancelación u Oposición (ARCO), así como limitar el uso o revocar el consentimiento previamente otorgado. Para ello, deberá enviar una solicitud a informes@crovexa.com, la cual deberá contener: {/* [cite: 210, 211] */}</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p>Crovexa responderá a la solicitud en un plazo máximo de 20 días hábiles a partir de su recepción y notificará al solicitante a través del medio indicado en la misma. {/* [cite: 215] */}</p>
            ...
            <p>Crovexa implementa medidas técnicas, administrativas y físicas razonables para proteger los datos personales contra pérdida, uso indebido, acceso no autorizado, alteración o destrucción. No obstante, el titular reconoce que ninguna transmisión de datos por Internet es completamente segura y que Crovexa no puede garantizar la invulnerabilidad absoluta de sus sistemas. {/* [cite: 222, 223] */}</p>

            <h2 className="text-2xl font-bold text-slate-900 mt-8">8. Cambios al Aviso de Privacidad</h2>
            <p>Crovexa podrá modificar en cualquier momento el presente Aviso de Privacidad para atender cambios legislativos, políticas internas o nuevos requerimientos para la prestación de servicios. Las modificaciones se publicarán en el sitio web y entrarán en vigor a partir de su publicación. {/* [cite: 225, 226] */}</p>
          </div>
        </div>
      </div>
    </main>
